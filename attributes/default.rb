...
default[:nat][:golang][:tag] = "go1.9.1"
...
default[:nat][:vim][:plugins] = [
  ...
  {'path'=>'.vim/bundle/syntastic', 'url'=>'git://github.com/scrooloose/syntastic.git'},
  ...
  {'path'=>'.vim/bundle/vim-flake8', 'url'=>'git://github.com/nvie/vim-flake8.git'},
  {'path'=>'.vim/bundle/vim-foreplay', 'url'=>'git://github.com/tpope/vim-foreplay.git'},
  {'path'=>'.vim/bundle/vim-git', 'url'=>'git://github.com/tpope/vim-git.git'},
  {'path'=>'.vim/bundle/vim-gitsessions', 'url'=>'git://github.com/wting/gitsessions.vim.git'},
  {'path'=>'.vim/bundle/vim-gocode', 'url'=>'git://github.com/Blackrush/vim-gocode.git'},
  {'path'=>'.vim/bundle/vim-golang', 'url'=>'git://github.com/jnwhiteh/vim-golang.git'},
  ...
  {'path'=>'.vim/bundle/vim-rspec', 'url'=>'git://github.com/thoughtbot/vim-rspec.git'},
  {'path'=>'.vim/bundle/vim-scala', 'url'=>'git://github.com/derekwyatt/vim-scala.git'},
  {'path'=>'.vim/bundle/vim-stylus', 'url'=>'git://github.com/wavded/vim-stylus.git'},
  ...
  {'path'=>'.vim/bundle/typescript-vim', 'url'=>'https://github.com/leafgarland/typescript-vim.git'},
]
